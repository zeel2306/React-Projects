...
export default function StatsSection() {
  const stats = [
    ...
    { id: 2, icon: <FaAward size={40} color="blue" />, number: "10k+", text: "Fresh & Quality Products" },
    { id: 3, icon: <FaCity size={40} color="blue" />, number: "200+", text: "Delivering Cities" },
    { id: 4, icon: <FaShippingFast size={40} color="blue" />, number: "365 Days", text: "Express Delivery" },
  ];
